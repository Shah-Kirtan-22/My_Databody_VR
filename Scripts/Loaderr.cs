...
public class Loaderr : MonoBehaviour {
	...
	public string fname = "00.raw";
	public string imageDir = "Assets/Resources/4d_Croped_Seq_v5_con";
	public int[] dim = new int[3] {512, 512, 8};
	public bool mipmap;

	private string xmlname = "Assets/Resources/color-transfer-functions/t-cv11.xml";

	public MHDHeaderr mhdheader;
	private float[,] cTable;

	public int NumberOfFrames = 89;
	...
	void Start() {
		...
		Read_MHD_Header (Path.Combine (imageDir, "00.mhd"));

		for (int k = 0; k < NumberOfFrames; k++) {
			string fname_ = "" + k.ToString("D2");
